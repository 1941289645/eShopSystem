<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-input suffix-icon="el-icon-position" style="width:200px" placeholder="请输入课号" class="ml-5" v-model="lnumber"></el-input>
      <el-input suffix-icon="el-icon-phone" style="width:200px" placeholder="请输入教师号" class="ml-5" v-model="tnumber"></el-input>
...
<!--      <el-table-column type="selection" width="55"></el-table-column>  &lt;!&ndash;选择框&ndash;&gt;-->
      ...
      <el-table-column prop="tnumber" label="教师号" align="center"></el-table-column>
